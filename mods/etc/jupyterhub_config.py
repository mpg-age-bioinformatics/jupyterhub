...
#c.JupyterHub.bind_url = 'https://jupyterhub.age.mpg.de:8000'
...
#c.JupyterHub.data_files_path = '/beegfs/common/software/2017/modules/software/jupyterhub/0.9.4/share/jupyterhub'
...
c.JupyterHub.ssl_cert = '/etc/jupyterhub/ssl/key-jupyterhub.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
#c.JupyterHub.ssl_key = ''
c.JupyterHub.ssl_key = '/etc/jupyterhub/ssl/privkey-jupyterhub.pem'
